    ...
    <div class="wrapping-panel" id="reg-form-panel">
        <div class="container">
            ...
            <div class="col-md-8" id="registration-form-panel">
                ...
                {{ Form::open(array('route'=>'pages.faculty.store', 'name'=>'reg-form', 'id'=>'reg-form'))}}
