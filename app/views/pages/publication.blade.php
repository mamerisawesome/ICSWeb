	...
	<div class="row" id="body-wrapper">
		<div class="container">
			...
			<div class="col-md-3" id="left-panel">
				<div id="ics-publication">
					<h5>{ ABOUT ICS PUBLICATIONS }</h5>
				</div>
				
				<div id="search-panel">
					<input type="text" id="search-bar-publication" value="Search Other Documents">
					<a href="#"><span class="glyphicon glyphicon-search" id="search-icon-publication"></span></a>
				</div>
				
				<div class="links-panel">
					<p class="links-pub">LINKS</p>
				</div>
				<div class="links-panel">
					<p class="links-pub">LINKS</p>
				</div>
			...
			<div class="col-md-9" id="publication-preview">
				<div id="title-panel">
					<h3 class="texts">ICS BEARS 500 GRADUATES, 2015<br><small>by ics publication<small></h3>
				</div>
				<hr>
				<div id="body-panel">
