		...
		<div class="container">
			<div class="row col-md-3" id="profile-panel">
				...
				<div id="user-info-wrapper">
					<div id="prof-pic">
						<img src="{{URL::to('res/images/sample3.png')}}" alt="Profile-Pic">
					</div>
					<div id="user-info">
				...
				<div class="col-sm-12" id="inbox-panel">
					<a href="#"><div>
						<div class="col-sm-4">
							<a href="#"><img src="{{URL::to('res/images/envelope.png')}}" id="inbox-pic" class="img-rounded" alt="INBOX"></a>
						</div>
						<div class="col-sm-8">
							<h3>INBOX</h3>
						</div>
				...
				<div class="col-sm-12" id="group-panel">
					<a href="#"><div>
						<div class="col-sm-4">
							<a href="#"><img src="{{URL::to('res/images/group.png')}}" id="group-pic" class="img-rounded" alt="GROUPS"></a>
						</div>
						<div class="col-sm-8">
